...
function getCookies(_a) {
	...
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_b) {
			switch (_b.label) {
				case 0:
					return [4 /*yield*/, node_fetch_1.default("https://www.twitch.tv/" + username, { agent: agent })];
				case 1:
					req = _b.sent();
		...
		return __generator(this, function (_c) {
			switch (_c.label) {
				case 0:
					return [
						4 /*yield*/,
						node_fetch_1.default("https://gql.twitch.tv/gql", {
							agent: agent,
							headers: {
...
function view(_a) {
	...
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_c) {
			switch (_c.label) {
				case 0:
					return [4 /*yield*/, getCookies(channel)];
				case 1:
					cookie = _c.sent();
				...
				case 2:
					...
					return [
						4 /*yield*/,
						fetchPlaylistUrl({ channel: channel, token: token, signature: signature, agent: agent }),
					];
				case 3:
					playlistUrl = _c.sent();
					...
					return [
						4 /*yield*/,
						node_fetch_1.default(
							"https://countess.twitch.tv/ping.gif?u=" +
								encodeURIComponent({ type: "channel", id: channel_id })
						),
					];
				case 4:
					ping = _c.sent();
							...
							body: JSON.stringify([
								{
									...
									extensions: {
										persistedQuery: {
											version: 1,
											sha256Hash:
												"38bbbbd9ae2e0150f335e208b05cf09978e542b464a78c2d4952673cd02ea42b",
										},
									},
								},
							]),
				...
				case 8:
					return [
						2 /*return*/,
						sendViews({ playlistUrl: playlistUrl, agent: agent, i: 0, persist: persist }),
					];
			}
		});
	});
			...
			switch (_b.label) {
				case 0:
					return [
						4 /*yield*/,
						node_fetch_1.default(
							"https://static.twitchcdn.net/config/settings.b3e1951c3857d8afda25a4a4d9d76913.js"
						),
					];
				case 1:
					return [4 /*yield*/, _b.sent().text()];
				case 2:
					settingsText = _b.sent();
					spade_url = JSON.parse(
						settingsText.slice("window.__twilightSettings = ".length).replaceAll("\n", "\\n")
					).spade_url;
							...
							return __generator(this, function (_a) {
								switch (_a.label) {
									...
									case 2:
										...
										return [
											4 /*yield*/,
											node_fetch_1.default(spade_url, {
												method: "POST",
												body: body,
											}),
										];
...
function sendViews(_a) {
	var playlistUrl = _a.playlistUrl,
		agent = _a.agent,
		i = _a.i,
		persist = _a.persist;
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_b) {
			switch (_b.label) {
				case 0:
					return [4 /*yield*/, fetchPlaylist({ playlist: playlistUrl, agent: agent })];
				case 1:
					playlist = _b.sent();
				...
				case 2:
					...
					if (persist) {
						setTimeout(
							sendViews.bind(null, { playlistUrl: playlistUrl, agent: agent, i: i, persist: persist }),
							1000 * 5
						);
					}
					return [2 /*return*/];
	...
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
							...
							switch (_a.label) {
								case 0:
									...
									tor.on("exit", function () {
										return console.log("[Tor] killed: " + counter);
									});
									tor.on("error", function (error) {
										return console.error("[Tor] err", error);
									});
									...
									promises.push(
										new Promise(function (res, rej) {
											...
											setTimeout(function () {
												return rej(new Error("[Tor] timeout connect"));
											}, 1000 * 30);
										})
									);
				...
				case 5:
					catched = _a.sent();
					filtered = catched.filter(function (result) {
		...
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					return [
						4 /*yield*/,
						promises_1.default.readFile(__dirname + "/proxy-scraper/alive.txt", { encoding: "utf8" }),
					];
				case 1:
					lines = _a.sent();
					return [
										...
										return __generator(this, function (_b) {
											switch (_b.label) {
												case 0:
													...
													return [
														4 /*yield*/,
														node_fetch_1.default("https://api.my-ip.io/ip", {
															agent: agent,
															timeout: 1000 * 3,
														}),
													];
												...
												case 2:
													...
													return [
														2 /*return*/,
														new https_proxy_agent_1.default({
															host: host,
															port: port,
															timeout: 1000 * 3,
														}),
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						...
						if (threads[i] == false) return [2 /*return*/];
						_a.label = 1;
					case 1:
						_a.trys.push([1, 4, , 5]);
						i = torI++;
...
promises_1.default
	.readFile(path_1.default.join(__dirname, "channel.txt"), { encoding: "utf8" })
	.then(function (channel) {
		return __awaiter(void 0, void 0, void 0, function () {
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, promises_1.default.mkdir(__dirname + "/tmp").catch(function (e) {})];
					case 1:
						_a.sent();
